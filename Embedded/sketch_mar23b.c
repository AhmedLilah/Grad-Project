...
#define safe_angle_servo_1  90
#define safe_angle_servo_2  90
#define safe_angle_servo_3  90
#define PinClK_pin_1  1
#define PinClK_pin_2  2
...
void loop() {
  ...
  for(int i = 0 ; i<stepDenominator*3; i++)
  {
    ...
    myservo_1.write(safe_angle_servo_1);
    myservo_2.write(safe_angle_servo_2);
    myservo_3.write(safe_angle_servo_3);
            break;}
